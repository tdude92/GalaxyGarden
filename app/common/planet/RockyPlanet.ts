...
export class RockyPlanet extends Planet {
    ...
    generateElevations(seed: number): Float64Array {
        ...
        for (let y = 0.5; y < this.tex_h; ++y) {
            ...
            for (let x = 0.5; x < this.tex_w; ++x) {
                ...
                let noiseOut = fractalNoise3D_Spherical(theta, phi, r_cylinder, 0.015, noise, 6, 2.1, 0.6);
    ...
    generatePalette(seed: number): void {
        ...
        this.palette = new Palette(PaletteType.Analogous, seed + 100);
